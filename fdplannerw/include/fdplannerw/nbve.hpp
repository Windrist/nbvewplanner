...
namespace nbvePlanner {
    ...
    class Planner {
        ...
        public:
            ...
            bool plannerCallback(fdplannerw::nbvep_srv::Request& req, fdplannerw::nbvep_srv::Response& res);
            bool rePlannerCallback(fdplannerw::nbvep_resrv::Request& req, fdplannerw::nbvep_resrv::Response& res);
