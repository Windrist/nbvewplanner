...
namespace nbvePlanner {
    ...
    bool Planner::plannerCallback(fdplannerw::nbvep_srv::Request& req,
                                                          fdplannerw::nbvep_srv::Response& res) {
        ...
        while ((!(tree_->gainFound() && tree_->frontierFound()) || tree_->getCounter() < params_.initIterations_) && ros::ok()) {
    ...
    bool Planner::rePlannerCallback(fdplannerw::nbvep_resrv::Request& req,
                                                          fdplannerw::nbvep_resrv::Response& res) {
