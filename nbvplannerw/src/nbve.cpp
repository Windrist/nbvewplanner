...
namespace nbvePlanner {
    ...
    bool Planner::plannerCallback(nbvplannerw::nbvep_srv::Request& req,
                                                          nbvplannerw::nbvep_srv::Response& res) {
    ...
    bool Planner::rePlannerCallback(nbvplannerw::nbvep_resrv::Request& req,
                                                          nbvplannerw::nbvep_resrv::Response& res) {
