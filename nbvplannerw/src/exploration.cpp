...
#include "nbvplannerw/CountVoxel.h"
...
void mapCallback(const nav_msgs::OccupancyGrid& msg) {
    nbvplannerw::CountVoxel countVox;
...
int main(int argc, char** argv) {
    ...
    mapCountPub = nh.advertise<nbvplannerw::CountVoxel>("/countArea", 1000);
    ...
    nbvplannerw::nbvep_srv planSrv;
    nbvplannerw::nbvep_resrv planReSrv;
