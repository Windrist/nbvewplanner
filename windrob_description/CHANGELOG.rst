^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package windrob_description
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.2.3 (2020-03-03)
------------------
* Updated inertial data in waffle_for_open_manipulator.urdf.xacro, waffle_pi_for_open_manipulator.urdf.xacro
* Added manipulation_slam.launch for TurtleBot3 SLAM with OpenMANIPULATOR
...
* modified laser update_rate and add param on diff_drive #258
