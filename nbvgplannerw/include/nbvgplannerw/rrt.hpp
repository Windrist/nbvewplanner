...
#include "nbvgplannerw/node.hpp"
#include "nbvgplannerw/random_double_generator.hpp"
#include "nbvgplannerw/collision_detector.hpp"
#include "nbvgplannerw/TreeMsg.h"
    ...
    class RRT {
        ...
        public:
            struct Params {
                ...
                Eigen::Vector2d miniBoundingBox_;
            ...
            void publishTreePoints(Eigen::Vector3d state, rviz_visual_tools::colors color);
