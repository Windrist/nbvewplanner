...
#include "nbvgplannerw/pe.hpp"
#include "nbvgplannerw/nbvep_srv.h"
#include "nbvgplannerw/nbvep_resrv.h"
...
namespace nbvePlanner {
    ...
    class Planner {
        ...
        public:
            ...
            bool plannerCallback(nbvgplannerw::nbvep_srv::Request& req, nbvgplannerw::nbvep_srv::Response& res);
            bool rePlannerCallback(nbvgplannerw::nbvep_resrv::Request& req, nbvgplannerw::nbvep_resrv::Response& res);
