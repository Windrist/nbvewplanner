...
#include "nbvgplannerw/CountVoxel.h"
...
void mapCallback(const nav_msgs::OccupancyGrid& msg) {
    nbvgplannerw::CountVoxel countVox;
...
int main(int argc, char** argv) {
    ...
    mapCountPub = nh.advertise<nbvgplannerw::CountVoxel>("/countArea", 1000);
    ...
    nbvgplannerw::nbvep_srv planSrv;
    nbvgplannerw::nbvep_resrv planReSrv;
